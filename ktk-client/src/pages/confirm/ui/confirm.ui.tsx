...
export const ConfirmPage: React.FC = () => {
    return (
        <div className="w-screen h-screen flex justify-center items-center">
            <div className="max-w-120 text-center rounded-sm border p-7 pb-8 border-[#989A99] mx-3 max-sm:p-4">
                <CheckCircle2 className="m-auto mb-5" size={70} />
                <div className="mb-5 text-2xl font-medium">Электронная почта успешно активирована!</div>
                <p className="mb-7">
                ...
                <Link className="bg-primary text-white rounded-md px-3 py-3" to="/">
